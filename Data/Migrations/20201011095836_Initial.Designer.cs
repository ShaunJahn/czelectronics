...
namespace czelectronics.Data.Migrations
{
    ...
    [Migration("20201011095836_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("czelectronics.Data.Models.MainForm.Form", b =>
                {
            ...
            modelBuilder.Entity("czelectronics.Data.Models.MainForm.Form", b =>
                {
                    b.HasOne("czelectronics.Data.Models.Customer", "CustomerNavigation")
                        ...
                        .HasForeignKey("czelectronics.Data.Models.MainForm.Form", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("czelectronics.Data.Models.Status", "StatusNavigation")
                        .WithOne("FormNavigation")
                        .HasForeignKey("czelectronics.Data.Models.MainForm.Form", "StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("czelectronics.Data.Models.StoreCode", "StoreCodeNavigation")
                        .WithOne("FormNavigation")
                        .HasForeignKey("czelectronics.Data.Models.MainForm.Form", "StoreCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("czelectronics.Data.Models.Product", b =>
                {
                    b.HasOne("czelectronics.Data.Models.MainForm.Form", "FormNavigation")
